...
export default function HeaderWMS({ toggleSidebar }) {
    ...
    // MENU RÁPIDO WMS
    const { atalhos } = useMenuRapidoWMS();
                        ...
                        {atalhos
                            ...
                            .map((item) => (
                                <Link
                                    key={item.id}
                                    to={
                                        item.rota.startsWith("/modulo-wms")
                                            ? item.rota
                                            : `/modulo-wms${item.rota}`
                                    }
                    ...
                    <div className="relative">
                        ...
                        {showAppsMenu && (
                            <div className="absolute right-0 mt-2 w-64 bg-white rounded shadow-lg border z-50 p-3 grid grid-cols-3 gap-4">
                                {[
                                    { icon: "fa-warehouse", label: "WMS" },
                                    { icon: "fa-boxes-stacked", label: "Estoque" },
                                    { icon: "fa-dolly", label: "Recebimento" },
                                    { icon: "fa-truck", label: "Expedição" },
