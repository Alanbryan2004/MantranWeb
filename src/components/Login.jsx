...
export default function Login({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Normaliza entrada (ignora maiúsculas/minúsculas e espaços)
    ...
    // Confere se é um dos usuários permitidos e senha = 1234
    if (
      usuariosValidos.includes(usuarioDigitado) &&
      senhaDigitada === "1234"
    ) {
      // Salva o nome do usuário para uso global (chat, menus, etc.)
      localStorage.setItem("usuarioNome", usuarioDigitado);

      // Dispara login normal
      onLogin?.();
    } else {
