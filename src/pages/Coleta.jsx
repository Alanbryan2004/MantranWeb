          ...
          <>
            ...
            <div className="border border-gray-300 rounded p-2 bg-white space-y-2">
              ...
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <Txt type="time" className="col-span-1" />
            ...
            <div className="border border-gray-300 rounded p-2 bg-white space-y-2">
              ...
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <div className="col-span-2 flex items-center gap-1">
                  <Txt className="w-[60px]" defaultValue="08:00" />
                  <span className="text-xs">às</span>
                  <Txt className="w-[60px]" defaultValue="12:00" />
                  <span className="text-xs">-</span>
                  <Txt className="w-[60px]" defaultValue="13:00" />
                  <span className="text-xs">às</span>
                  <Txt className="w-[60px]" defaultValue="18:00" />
                </div>
              ...
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <Txt className="col-span-9 bg-gray-200" readOnly placeholder="Razão Social" />
              </div>

              {/* LINHA 3 — CEP / Cidade / UF / Bairro */}
              <div className="grid grid-cols-12 gap-2 items-center">
                <Label className="col-span-1">CEP</Label>
                <Txt className="col-span-2" placeholder="00000-000" />

                <Label className="col-span-1">Cidade</Label>
                <Txt className="col-span-3" placeholder="Cidade" />

                <Label className="col-span-1">UF</Label>
                <Txt className="col-span-1 text-center" maxLength={2} />
              ...
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <Txt className="col-span-9" placeholder="Rua / Avenida" />
              ...
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <Txt className="col-span-1" defaultValue="0000" />
                <Txt className="col-span-4 bg-gray-200" readOnly placeholder="Descrição do Produto" />

                <Label className="col-span-1">Embal.</Label>
                <Txt className="col-span-1" defaultValue="000" />
                <Txt className="col-span-4 bg-gray-200" readOnly placeholder="Tipo de Embalagem" />
              </div>

              {/* LINHA 7 — Observação */}
              <div className="grid grid-cols-12 gap-2 items-center">
                <Label className="col-span-1">Obs.</Label>
                <Txt className="col-span-11" placeholder="Observações sobre a coleta" />
              </div>
