          ...
          <fieldset className="border border-gray-300 rounded p-3">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <input
                ...
                className="border border-gray-300 rounded px-2 h-[24px] w-[180px]"
              />
              <input
                type="text"
                ...
                value={cliente.razao}
                onChange={(e) =>
                  setCliente({ ...cliente, razao: e.target.value })
                }
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <input
                ...
                className="border border-gray-300 rounded px-2 h-[24px] w-[60px] text-center"
              />
