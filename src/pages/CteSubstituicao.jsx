          ...
          <fieldset className="border border-gray-300 rounded p-3">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setDados({ ...dados, remetenteCNPJ: e.target.value })
                }
                className="border border-gray-300 rounded px-2 py-[2px] h-[24px] w-[160px]"
              />
              <input
                type="text"
                ...
                onChange={(e) =>
                  setDados({ ...dados, remetenteRazao: e.target.value })
                }
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setDados({ ...dados, destinatarioCNPJ: e.target.value })
                }
                className="border border-gray-300 rounded px-2 py-[2px] h-[24px] w-[160px]"
              />
              <input
                ...
                onChange={(e) =>
                  setDados({ ...dados, destinatarioRazao: e.target.value })
                }
                className="border border-gray-300 rounded px-2 py-[2px] h-[24px] flex-1"
              />
            </div>
