...
export default function FilialNumeracao({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white w-[600px] max-w-[95vw] rounded-md shadow-xl p-4">
        ...
        <div className="grid md:grid-cols-2 gap-3 text-[12px]">
          ...
          <fieldset className="border border-gray-300 rounded p-2">
            ...
            <div className="mt-1 space-y-1">
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último Controle</Label>
                <Txt className="flex-1 text-right" defaultValue="264730" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último CTe</Label>
                <Txt className="flex-1 text-right" defaultValue="264375" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Série do CTe</Label>
                <Txt className="flex-1 text-right" defaultValue="001" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última Coleta</Label>
                <Txt className="flex-1 text-right" defaultValue="185708" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última Viagem</Label>
          ...
          <fieldset className="border border-gray-300 rounded p-2">
            ...
            <div className="mt-1 space-y-1">
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última Fatura</Label>
                <Txt className="flex-1 text-right" defaultValue="046496" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última OS</Label>
                <Txt className="flex-1 text-right" defaultValue="001452" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última Ocorrência</Label>
                <Txt className="flex-1 text-right" defaultValue="029275" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último Romaneio</Label>
          ...
          <fieldset className="border border-gray-300 rounded p-2">
            ...
            <div className="mt-1 space-y-1">
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Última NF Serviço</Label>
                <Txt className="flex-1 text-right" defaultValue="014051" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº NF Saída</Label>
                <Txt className="flex-1 text-right" defaultValue="000024" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Série NF Serviço</Label>
                <Txt className="flex-1 text-right" defaultValue="005" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último Manifesto</Label>
          ...
          <fieldset className="border border-gray-300 rounded p-2">
            ...
            <div className="mt-1 space-y-1">
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último MDF-e</Label>
                <Txt className="flex-1 text-right" defaultValue="001374" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Série MDF-e</Label>
                <Txt className="flex-1 text-right" defaultValue="000" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Nº Último NSU</Label>
                <Txt className="flex-1 text-right" defaultValue="000000000587843" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Créd Série</Label>
                <Txt className="flex-1 text-right" defaultValue="001" />
              </div>
              <div className="flex items-center gap-2">
                <Label className="w-[130px]">Deb Série</Label>
                <Txt className="flex-1 text-right" defaultValue="001" />
              </div>
            </div>
          </fieldset>
