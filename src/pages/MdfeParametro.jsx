            ...
            <div className="bg-white w-[1100px] rounded shadow p-4 border border-gray-300 max-h-[95vh] overflow-auto">
                ...
                <fieldset className="border border-gray-300 rounded p-3 mb-4">
                    ...
                    <div className="grid grid-cols-12 gap-2 mb-2">
                        ...
                        <Label className="col-span-2">UF Emitente</Label>
                        <Sel
                    ...
                    <div className="grid grid-cols-12 gap-2 mb-2">
                        ...
                        <Label className="col-span-2">Senha e-mail</Label>
                        <Txt
                            className="col-span-4"
                            type="password"
                    ...
                    <div className="grid grid-cols-12 gap-2 mb-2">
                        ...
                        <Label className="col-span-1">Requer Autenticação</Label>
                        ...
                        <Label className="col-span-1">Envio Automático</Label>
                        <div className="col-span-1 flex items-center">
                            <input
                                type="checkbox"
