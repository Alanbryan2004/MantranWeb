...
export default function NotaFiscalModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 text-[13px]">
      <div className="bg-white w-[1150px] rounded shadow-lg border border-gray-300 p-3">
        {/* Cabeçalho */}
        ...
        <fieldset className="border border-gray-300 rounded p-3">
                ...
                <label className="flex items-center gap-1 text-[12px] text-gray-600">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setDta(on);
                      if (on) {
                        // DTA -> Chave e Série não editáveis
          ...
          <div className="grid grid-cols-12 gap-2">
            ...
            />
            <Txt className="col-span-4 w-full" readOnly value={dados.embDesc} />
            ...
            <Txt
              ...
              onBlur={() => {
                // ao passar pelo campo Prod. inclui automaticamente
                incluirOuAlterarCard1();
              }}
            />
            <Txt className="col-span-4 w-full" readOnly value={dados.prodDesc} />
          </div>
        </fieldset>
