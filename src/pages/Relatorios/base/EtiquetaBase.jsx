...
export default function EtiquetaBase({
    ...
    // regra: se existir preset com labelConfig, ele manda.
    ...
    // Ordem padrão por zona (ordem do catálogo)
    ...
    // Quando muda reportKey/templateId/labelKind, re-hidrata
    useEffect(() => {
        const p = loadPreset(reportKey, templateId, labelKind);
    ...
    // Campos ativos por zona seguindo ordem
    ...
    return (
        <div id="etiqueta-print-root" className="w-full">
            {/* ================= TOOLBAR ================= */}
            <div className="sticky z-40 bg-white border-b border-gray-300 top-[44px]">
            ...
            {/* ================= VIEWPORT ================= */}
            <div ref={scrollRef} className="bg-gray-200 w-full overflow-y-auto" style={{ height: "calc(100vh - 110px)" }}>
                ...
                <div className="fixed inset-0 z-50">
                    ...
                    <div className="absolute right-0 top-0 h-full w-[560px] bg-white shadow-xl flex flex-col">
                        <div className="p-4 border-b flex items-center justify-between">
                            ...
                            <button onClick={() => setConfigOpen(false)} className="px-3 h-[30px] border border-gray-300 rounded text-[12px]">
                                X
                            </button>
                        </div>
                        ...
                        <div className="p-4 flex-1 overflow-auto">
                            ...
                            <div className="mb-6 border rounded">
                                <div className="px-3 py-2 border-b bg-gray-50 text-[12px] font-semibold">Tamanho da etiqueta (mm)</div>
                                        ...
                                        <div key={z.id} className="border rounded">
                                            ...
                                            <div className="p-3 grid grid-cols-2 gap-3">
                                                ...
                                                <div className="border rounded">
                                                    <div className="px-2 py-2 border-b bg-white text-[12px] font-semibold">Selecionados</div>
                                                    ...
                                                    <div className="p-2 max-h-[240px] overflow-auto">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        disabled={!!f.required}
                                                                        className={`px-2 h-[26px] border rounded text-[12px] ${f.required ? "border-gray-200 text-gray-300 cursor-not-allowed" : "border-gray-300"
                                                                            }`}
                                                        ...
                                                        {!enabledList.length ? (
                                                            <div className="p-3 text-[12px] text-gray-400">Nenhum campo selecionado nesta área.</div>
                                                        ) : null}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="border rounded">
                                                    ...
                                                    <div className="p-2 max-h-[240px] overflow-auto">
                                                        {disabledList.map((f) => (
                                                            <div key={f.id} className="flex items-center justify-between gap-2 px-2 py-1 border-b last:border-b-0">
                                                                <div className="text-[12px] text-gray-700">
                                                                    <b>{f.label}</b>
                                                        ...
                                                        {!disabledList.length ? (
                                                            <div className="p-3 text-[12px] text-gray-400">Nenhum campo disponível nesta área.</div>
                                                        ) : null}
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="p-4 border-t flex items-center justify-between">
                            <div className="text-[11px] text-gray-500">Dica: arraste os campos dentro de cada área para reordenar ✨</div>
